...
#####################################
# System information. Not that this is useful in anyway or even reliable... but
# it helps devs that don't have access/info to the underlying
# infra in k8s get a hint on what kind of hardware is supporting the pods.
# The info is quite reliable in Azure VMs.
#####################################
